...
spam(){
    ...
    echo "[1] Spam SMS"
    echo "[2] Spam Telp"
    echo "[3] Close Script Baturaja Cyber Army"
    echo
    echo "1/2/3?"
    read pilih
    if [ $pilih = "1" ]; then
            echo "Script Spam SMS"
            #function spam
            echo
            ...
            echo
            echo "Berapa sms yang mau anda dikirim?"
            read paket
            echo
            ...
            if [ $confirm = "y" ]; then
                    ...
                    echo
                    echo "Jangan close aplikasi sebelum spam selesai Anjay"
                    echo "========================================"
        ...
        mulai
            ...
            if [ $confirm = "y" ]; then
                  ...
                  echo
                  echo "Jangan close aplikasi sebelum spam selesai Anjir"
                  echo "========================================"
                  cek_target=`curl -s $get_call/call.php?nomor=$target"&method="$api_spam`
                  echo -e $cek_target
                  echo " Gunakan tools dengan bijak Kawan"
                  echo
                  echo " Love u always "
                  echo " -zLucifer"
                  echo "========================================"
        ...
        echo "Terimakasih sudah menggunakan Script Baturaja Cyber Army"
        close
    else
        clear
        echo "Kesalahan"
...
clear
troll
echo Selamat datang Kawan, Siapa Nama Lo? #tulisan keluar
read nick #membaca yang ditulis
clear
troll
echo Selamat datang cuk $nick ":)"
echo
echo "Mulai Script Baturaja Cyber Army?"
echo "y/n?"
read mulai
if [ $mulai = "y" ]; then
      spam
