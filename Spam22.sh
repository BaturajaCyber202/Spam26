...
spam(){
    ...
    echo "[1] Spam SMS"
    echo "[2] Spam Telp"
    echo "[3] Close Baturaja Cyber Army"
    echo
    echo "1/2/3?"
    read pilih
    if [ $pilih = "1" ]; then
            ...
            #function spam
            echo
            echo "Silahkan masukan nomor telp target Coy"
            echo contoh 0812345678
            read target # masukin no telp
            echo
            echo "Berapa sms yang mau dikirim kan?"
            read paket
            echo
            ...
            if [ $confirm = "y" ]; then
                    ...
                    echo " Gunakan Script ini dengan bijak"
                    echo
                    echo " Love u always "
                    echo " -zLucifer"
                    echo "======================================="
            else
                    echo "Kesalahan Anjir"
            fi
        mulai
    elif [ $pilih = "2" ]; then
            ...
            #function spam
            echo
            echo "Silahkan masukan nomor telp target dlu coy"
            echo contoh 0812345678
            read target # masukin no telp
            echo
            ...
            if [ $confirm = "y" ]; then
                  ...
                  echo
                  echo "Jangan close aplikasi sebelum spam selesai coy"
                  echo "========================================"
                  ...
                  echo Kesalahan, silahkan coba lagi wkk :v
            fi
        mulai
    elif [ $pilih = "3" ]; then
...
clear
troll
echo Selamat datang Jok, Siapa Nama Lu? #tulisan keluar
